         ...
         <div className="left flex flex-col  items-center md:w-[50%] ">
            <div>
              <Image
                ...
                height={400}
                width={400}
                className="md:rounded-3xl rounded-full px-5 md:px-0 pt-10 md:pt-0"
              />
            </div>
            <div className="details font-light text-gray-400 w-[94%] md:w-[70%] pt-7">
              ...
              <p className="py-2 ">
                Hey! Welcome I&apos;m delighted to have you here.I am a
                passionate Computer Science Engineer and
